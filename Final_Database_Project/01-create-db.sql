...
DROP 
  TABLE FORECAST CASCADE CONSTRAINTS;
DROP 
  TABLE LOCATION CASCADE CONSTRAINTS;
DROP 
  TABLE PERSON CASCADE CONSTRAINTS;
DROP 
  TABLE REPAIRLOG CASCADE CONSTRAINTS;
DROP 
  TABLE SALARY CASCADE CONSTRAINTS;
DROP 
  TABLE STATION CASCADE CONSTRAINTS;
DROP 
  TABLE STATIONREADING CASCADE CONSTRAINTS;
DROP 
  TABLE STATION_HIST CASCADE CONSTRAINTS;
DROP 
  TABLE SUBSCRIPTION CASCADE CONSTRAINTS;
DROP 
  TABLE TECHNICIAN CASCADE CONSTRAINTS;
-----------------------------------------------------------------------
--Drop Sequences
-----------------------------------------------------------------------
DROP 
...
ALTER TABLE 
  "PERSON" 
ADD 
  CONSTRAINT "UNIQ_PERSON_TYPE" UNIQUE ("PERSONID", "PERSONTYPE");
ALTER TABLE 
  "PERSON" 
ADD 
  CONSTRAINT "PERSON_CHECK_C_OR_E" CHECK (
    PERSONTYPE IN ('E', 'C')
  ) ENABLE;
ALTER TABLE 
  "PERSON" MODIFY ("PERSONID" NOT NULL ENABLE);
ALTER TABLE 
  "PERSON" MODIFY ("EMAIL" NOT NULL ENABLE);
ALTER TABLE 
  "PERSON" MODIFY ("ACTIVE_USER" NOT NULL ENABLE);
ALTER TABLE 
  "PERSON" 
ADD 
...
ALTER TABLE 
  "PERSON" 
ADD 
  CONSTRAINT "UNIQ_ID_NUM" UNIQUE ("IDNUMBER");
ALTER TABLE 
  "PERSON" 
ADD 
...
ALTER TABLE 
  "EMPLOYEE" 
ADD 
  CONSTRAINT "UNIQ_EMPL_TYPE" UNIQUE ("PERSONID", "POSITIONTYPE");
ALTER TABLE 
  "EMPLOYEE" 
ADD 
  CONSTRAINT "PERSON_CHECK_E" CHECK (
    PERSONTYPE IN ('E')
  ) ENABLE;
ALTER TABLE 
  "EMPLOYEE" 
ADD 
  CONSTRAINT "CHECK_EMP_TYPE" CHECK (
    POSITIONTYPE IN ('T', '')
  ) ENABLE;
ALTER TABLE 
  "EMPLOYEE" MODIFY ("PERSONID" NOT NULL ENABLE);
ALTER TABLE 
  "EMPLOYEE" MODIFY ("POSITIONTYPE" NOT NULL ENABLE);
ALTER TABLE 
  "EMPLOYEE" 
ADD 
...
-----------------------------------------------------------------------
ALTER TABLE 
  "SALARY" MODIFY ("SALARYID" NOT NULL ENABLE);
ALTER TABLE 
  "SALARY" MODIFY ("DATEPAID" NOT NULL ENABLE);
ALTER TABLE 
  "SALARY" 
ADD 
...
-----------------------------------------------------------------------
ALTER TABLE 
  "CUSTOMER" MODIFY ("PERSONID" NOT NULL ENABLE);
ALTER TABLE 
  "CUSTOMER" 
ADD 
  CONSTRAINT "PERSON_CHECK_C" CHECK (
    PERSONTYPE IN ('C')
  ) ENABLE;
ALTER TABLE 
  "CUSTOMER" 
...
ALTER TABLE 
  "SUBSCRIPTION" MODIFY (
    "SUBSCRIPTION_TYPE" NOT NULL ENABLE
  );
ALTER TABLE 
  "SUBSCRIPTION" 
ADD 
  CONSTRAINT "SUBSCRIPTION_PK" PRIMARY KEY ("SUBSCRIPTION_TYPE");
-----------------------------------------------------------------------
--  Constraints for Table TECHNICIAN
-----------------------------------------------------------------------
ALTER TABLE 
  "TECHNICIAN" MODIFY ("PERSONID" NOT NULL ENABLE);
ALTER TABLE 
  "TECHNICIAN" 
ADD 
  CONSTRAINT "TECHNICIAN_PK" PRIMARY KEY ("PERSONID");
-----------------------------------------------------------------------
--  Constraints for Table REPAIRLOG
-----------------------------------------------------------------------
ALTER TABLE 
  "REPAIRLOG" MODIFY ("REPAIRID" NOT NULL ENABLE);
ALTER TABLE 
  "REPAIRLOG" MODIFY ("PERSONID" NOT NULL ENABLE);
ALTER TABLE 
  "REPAIRLOG" MODIFY ("STATIONID" NOT NULL ENABLE);
ALTER TABLE 
  "REPAIRLOG" 
ADD 
  CONSTRAINT "REPAIRLOG_PK" PRIMARY KEY (
    "REPAIRID", "PERSONID", "STATIONID"
  );
-----------------------------------------------------------------------
--  Constraints for Table STATION
-----------------------------------------------------------------------
ALTER TABLE 
  "STATION" MODIFY ("STATIONID" NOT NULL ENABLE);
ALTER TABLE 
  "STATION" 
ADD 
...
-----------------------------------------------------------------------
ALTER TABLE 
  "STATION_HIST" MODIFY ("HIST_ID" NOT NULL ENABLE);
ALTER TABLE 
  "STATION_HIST" 
ADD 
  CONSTRAINT "STATION_HIST_PK" PRIMARY KEY ("HIST_ID");
-----------------------------------------------------------------------
--  Constraints for Table LOCATION
-----------------------------------------------------------------------
ALTER TABLE 
  "LOCATION" MODIFY ("LOCATIONID" NOT NULL ENABLE);
ALTER TABLE 
  "LOCATION" 
ADD 
  CONSTRAINT "UNIQ_NAME" UNIQUE ("LOCATIONNAME");
ALTER TABLE 
  "LOCATION" 
ADD 
...
-----------------------------------------------------------------------
ALTER TABLE 
  "STATIONREADING" MODIFY ("READING_ID" NOT NULL ENABLE);
ALTER TABLE 
  "STATIONREADING" 
ADD 
  CONSTRAINT "STATIONREADING_PK" PRIMARY KEY ("READING_ID");
-----------------------------------------------------------------------
-- Constraints for Table FORECAST
-----------------------------------------------------------------------
ALTER TABLE 
  "FORECAST" MODIFY ("FORECAST_ID" NOT NULL ENABLE);
ALTER TABLE 
  "FORECAST" 
ADD 
...
ALTER TABLE 
  "CUSTOMER" 
ADD 
  CONSTRAINT "CUSTOMER_FK" FOREIGN KEY ("SUBSCRIPTION_TYPE") REFERENCES "SUBSCRIPTION" ("SUBSCRIPTION_TYPE") ENABLE;
ALTER TABLE 
  "CUSTOMER" 
ADD 
  CONSTRAINT "CUST_ISA_PERSON" FOREIGN KEY ("PERSONID", "PERSONTYPE") REFERENCES "PERSON" ("PERSONID", "PERSONTYPE") ENABLE;
-----------------------------------------------------------------------
...
ALTER TABLE 
  "EMPLOYEE" 
ADD 
  CONSTRAINT "PERSON_ISA_EMPL" FOREIGN KEY ("PERSONID", "PERSONTYPE") REFERENCES "PERSON" ("PERSONID", "PERSONTYPE") ENABLE;
-----------------------------------------------------------------------
...
ALTER TABLE 
  "SALARY" 
ADD 
  CONSTRAINT "SALARY_FK" FOREIGN KEY ("PERSONID") REFERENCES "EMPLOYEE" ("PERSONID") ENABLE;
-----------------------------------------------------------------------
...
ALTER TABLE 
  "TECHNICIAN" 
ADD 
  CONSTRAINT "EMPL_ISA_TECH" FOREIGN KEY ("PERSONID", "POSITIONTYPE") REFERENCES "EMPLOYEE" ("PERSONID", "POSITIONTYPE") ENABLE;
-----------------------------------------------------------------------
...
ALTER TABLE 
  "REPAIRLOG" 
ADD 
  CONSTRAINT "REPAIR_FK_STATION" FOREIGN KEY ("STATIONID") REFERENCES "STATION" ("STATIONID") ENABLE;
ALTER TABLE 
  "REPAIRLOG" 
ADD 
  CONSTRAINT "REPAIR_FK_TECH" FOREIGN KEY ("PERSONID") REFERENCES "TECHNICIAN" ("PERSONID") ENABLE;
-----------------------------------------------------------------------
...
ALTER TABLE 
  "STATION" 
ADD 
  CONSTRAINT "STATION_LOC_FK" FOREIGN KEY ("LOCATIONID") REFERENCES "LOCATION" ("LOCATIONID") ENABLE;
-----------------------------------------------------------------------
...
ALTER TABLE 
  "STATION_HIST" 
ADD 
  CONSTRAINT "STATION_HIST_FK" FOREIGN KEY ("STATIONID") REFERENCES "STATION" ("STATIONID") ENABLE;
-----------------------------------------------------------------------
...
ALTER TABLE 
  "STATIONREADING" 
ADD 
  CONSTRAINT "READING_FK" FOREIGN KEY ("STATIONID") REFERENCES "STATION" ("STATIONID") ENABLE;
-----------------------------------------------------------------------
...
ALTER TABLE 
  "FORECAST" 
ADD 
  CONSTRAINT "FORECAST_FK" FOREIGN KEY ("LOCATIONID") REFERENCES "LOCATION" ("LOCATIONID") ENABLE;
-----------------------------------------------------------------------
--  Sequence FORECAST_SEQ
-----------------------------------------------------------------------
...
INSERT INTO "PERSON" (
  ...
  PHONENUMBER, EMAIL, PERSONTYPE, USERNAME, 
  PASSWORD, ACTIVE_USER, BIRTH_DATE
) 
VALUES 
  (
    1, 
...
INSERT INTO "CUSTOMER" (
  PERSONID, SUBSCRIPTION_TYPE, PERSONTYPE
) 
VALUES 
  (2, 2, 'C');
-----------------------------------------------------------------------
...
INSERT INTO "EMPLOYEE" (
  PERSONID, POSITIONTITLE, POSITIONTYPE, 
  VATNUMBER, PERSONTYPE
) 
VALUES 
  (
    1, 'Head Manager', 'M', '1515415', 
    'E'
  );
INSERT INTO "EMPLOYEE" (
  PERSONID, POSITIONTITLE, POSITIONTYPE, 
...
VALUES 
  (
    3, 'Technician', 'T', '1541515', 'E'
  );
-----------------------------------------------------------------------
--  Add TECHNICIAN
-----------------------------------------------------------------------
INSERT INTO "TECHNICIAN" (
  PERSONID, HARDWARE_YES, SOFTWARE_YES, 
  POSITIONTYPE
) 
VALUES 
  (3, 1, 0, 'T');
...
--  Add SALARY
-----------------------------------------------------------------------
INSERT INTO "SALARY" (PERSONID, AMOUNT, DATEPAID) 
VALUES 
  (
    1, 
    30000.50, 
    TO_DATE(
      '2018-01-14 00:15:00', 'YYYY-MM-DD HH24:MI:SS'
    )
  );
INSERT INTO "SALARY" (PERSONID, AMOUNT, DATEPAID) 
VALUES 
  (
    ...
    15000.40, 
    TO_DATE(
      '2019-05-14 17:23:30', 'YYYY-MM-DD HH24:MI:SS'
    )
  );
-----------------------------------------------------------------------
--  Add LOCATION
...
INSERT INTO "LOCATION" (
  LOCATIONID, LOCATIONNAME, PROVINCE
) 
VALUES 
  (1, 'Anatombi', 'North West');
INSERT INTO "LOCATION" (
  LOCATIONID, LOCATIONNAME, PROVINCE
) 
VALUES 
  (
    2, '7 Postma Street', 'North West'
  );
-----------------------------------------------------------------------
--  Add STATION
-----------------------------------------------------------------------
INSERT INTO "STATION" (
  STATIONID, STATUS, LOCATIONID, COORDINATES, 
  ISACTIVE
) 
VALUES 
  (
    1, 'Working', 1, 'x:4574,23232;y:347864,23', 
    1
  );
INSERT INTO "STATION" (
  STATIONID, STATUS, LOCATIONID, COORDINATES, 
...
VALUES 
  (
    2, 'Offline', 1, 'x:4574,22;y:34764,23', 
    0
  );
INSERT INTO "STATION" (
  STATIONID, STATUS, LOCATIONID, COORDINATES, 
...
VALUES 
  (
    3, 'Working', 2, 'x:34737,123;y:374,534', 
    1
  );
-----------------------------------------------------------------------
--  Add FORECAST
...
INSERT INTO "FORECAST" (
  FORECASTDATE, LOCATIONID, TEMPERATURE, 
  AIR_PRESSURE, HUMIDITY, AMBIENT_LIGHT
) 
VALUES 
  (
    TO_DATE(
      '2019-05-21 17:52:08', 'YYYY-MM-DD HH24:MI:SS'
    ), 
    2, 
    32, 
    874.6, 
...
INSERT INTO "REPAIRLOG" (
  PERSONID, STATIONID, DATE_OF, DESCRIPTION
) 
VALUES 
  (
    3, 
    2, 
    TO_DATE(
      '2019-05-22 18:04:03', 'YYYY-MM-DD HH24:MI:SS'
    ), 
    'Fixed light sensor.'
  );
INSERT INTO "REPAIRLOG" (
...
VALUES 
  (
    ...
    1, 
    TO_DATE(
      '2019-07-12 18:04:03', 'YYYY-MM-DD HH24:MI:SS'
    ), 
    'Fixed faulty battery.'
  );
