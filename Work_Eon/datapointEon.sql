--------------------------------------------------------------------------------
--#################### 1. AVERGAE AIR PRESSURE PER LOCATION #####################
--------------------------------------------------------------------------------
-- average airpressure per lcoation per hour
SELECT
    T.HOUR AS "Hour of past day",
    L.LOCATION_NAME AS "Location Name",
    AVG(F.AVG_AIRPRESSURE) AS "AVG Air Pressure"
...
--------------------------------------------------------------------------------
-- average airpressure per lcoation per week
SELECT
...
--------------------------------------------------------------------------------
-- average airpressure per lcoation per month
SELECT
...
GROUP by T.DAY, L.LOCATION_NAME;
--------------------------------------------------------------------------------
-- average airpressure per lcoation per year
SELECT
...
--------------------------------------------------------------------------------
-- average airpressure per lcoation per all years
SELECT
    T.YEAR AS "Year",
    L.LOCATION_NAME AS "Location Name",
    AVG(F.avg_airpressure) AS "AVG Air Pressure"
...
--------------------------------------------------------------------------------
--#################### 2. AVERGAE AIR PRESSURE PER STATION ######################
--------------------------------------------------------------------------------

--Avergae airpressure per station per hour for last day
SELECT
...
--------------------------------------------------------------------------------
--Avergae airpressure per station per day for last week
SELECT
...
--------------------------------------------------------------------------------
--Avergae airpressure per station per day for last month
SELECT
...
GROUP by T.DAY, S.STATION_ID;
--------------------------------------------------------------------------------
--Avergae airpressure per station per month for last year
SELECT
...
--------------------------------------------------------------------------------
--Avergae airpressure per station per year for all time
SELECT
    T.YEAR AS "Year",
    S.STATION_ID AS "Station ID",
    AVG(F.avg_airpressure) AS "AVG Air Pressure"
